...
layui.define(['jquery', 'element', 'nprogress', 'utils'], function(exports) {
    ...
    var _tab = {
        ...
        createTabDom: function() {
            ...
            //模板
            var tpl = [
                    '<div class="layui-tab layui-tab-card kit-tab" lay-allowClose="true" lay-filter="' + that._filter + '">',
                    '<ul class="layui-tab-title">',
                    /*'<li class="layui-this" lay-id="-1" data-url="' + _config.a + '"><i class="layui-icon">&#xe68e;</i> 首页</li>',*/
                    '</ul>',
