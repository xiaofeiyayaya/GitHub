...
<head>
<title>登录</title>
<link href="${ctx }/css/login/login.css" rel="stylesheet" type="text/css"></link>
</head>
<body>
	<!-- 背景音乐 -->
	<!-- <embed src="../music/login.mp3" loop="true" autostar="true"
		hidden="true" /> -->
	<audio src="../music/login.mp3" autoplay="true" hidden="true"loop="true"> </audio>
	...
	<form class="layui-form" action="${ctx }/user/login" id="loginForm"
		...
		<div class="login-warp">
			<div class="login">
				...
				<div class="layui-form-item">
					<input class="layui-input" type="passWord" id="passWord" name="passWord"></input>
				...
				<div id="ajaxMsg"><span style="color:red;">${error}</span></div>
			</div>
		</div>
	</form>
</body>
