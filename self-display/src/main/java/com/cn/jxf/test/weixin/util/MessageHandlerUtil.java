...
import com.cn.jxf.test.weixin.commom.MessageType;
...
public class MessageHandlerUtil {
    ...
    public static String buildResponseMessage(Map map) {
        ...
        System.out.println("消息类型："+messageEnumType);
    ...
    private static String handleTextMessage(Map<String, String> map) {
        ...
        switch (content) {
            case "文本":
                String msgText = "s8 lol一定能夺冠 不信你去百度\n" +
                        "<a href=\"http://www.baidu.com\">百度一下</a>";
                responseMessage = buildTextMessage(map, msgText);
                break;
            case "图片":
                //通过素材管理接口上传图片时得到的media_id
                String imgMediaId = "BGq_vsH4GAjlvGoE9zeLKuUE9ezNG79I3ild0o_5f6dP4DPDTtZSic5YVEI6tQFp";
            ...
            case "音乐":
                ...
                music.title = "老街--李荣浩";
                music.description = "随便听听吧 只有这一首";
                music.musicUrl = "http://p2tdux.natappfree.cc/music/login.mp3";
                music.hqMusicUrl = "http://p2tdux.natappfree.cc/music/login.mp3";
