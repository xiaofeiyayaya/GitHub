...
public class WeChatApiUtil {
	...
	// 新增临时素材
	private static final String LINSHI_UPLOAD_MEDIA = "https://api.weixin.qq.com/cgi-bin/media/upload?access_token=%s&type=%s";
	...
	public static JSONObject uploadMedia(String filePath, String type) {
		...
		String appId = "wx4cd6995af1190e5c";
		String appSecret = "9225f3347821e7064b80f3ab6848d57f";
		String token = WeChatApiUtil.getToken(appId, appSecret);
	...
	public static void main(String[] args) throws Exception {
		// 媒体文件路径
		String filePath = "D:\\Workspace\\self-display\\src\\main\\resources\\static\\images\\login.jpg";
		// String filePath = "D:/JavaSoftwareDevelopeFolder/IntelliJ
		// IDEA_Workspace/WxStudy/web/media/image/我.jpg";
		// String filePath = "D:/JavaSoftwareDevelopeFolder/IntelliJ
